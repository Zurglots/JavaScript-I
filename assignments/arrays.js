// To help us use arrays with real world problems we are going
// to simulate a used car dealer that has 50 cars in their inventory.

// The car dealer has all of their inventory housed in the array seen below.
// Scroll down past the data to find out how you can help the car dealer.
...
//     }
// }
// return console.log(inventory[car_model.length]);
...
// how would this look without the arrow function
...
// let oldCars = [carYears.length];

let oldCars = carYears.filter(function(carAge) {
  return carAge <= 2000;
});

console.log(oldCars.length);

// I need to change this to an arrow function
...
let fancyCars = inventory.filter(function(carFancy) {
  return carFancy.car_make == "BMW" || carFancy.car_make == "Audi";
});

console.log(JSON.stringify(fancyCars));
